...
2. Ajoute dans `.env.local` / Vercel / GitHub Actions secrets :
   ...
   - `FIRECRAWL_API_KEY` (AI intel : pages des vendors essentiels uniquement)
     Sans cette clé, l’enrichissement d’article retombe sur un GET direct.
