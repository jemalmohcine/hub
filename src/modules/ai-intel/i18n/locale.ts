...
export const UI = {
  fr: {
    ...
    tabTools: "Outils",
    tabNews: "Actus",
    sectionUrgentDesc: "Faille, changement de prix, ou un outil qui change la donne",
    sectionGithubDesc: "Repos en tendance GitHub",
    ...
    emptyUrgentHint:
      "Uniquement une faille, un changement de prix, ou un outil révolutionnaire.",
    tldr: "Résumé",
    ...
    pageDesc:
      "Urgent = faille, prix, outil révolutionnaire. GitHub = repos en tendance.",
  ...
  en: {
    ...
    tabTools: "Tools",
    tabNews: "News",
    sectionUrgentDesc: "Security issue, price change, or a revolutionary tool",
    sectionGithubDesc: "GitHub trending repos",
    ...
    emptyUrgentHint:
      "Only a security issue, a price change, or a revolutionary tool.",
    tldr: "Summary",
    ...
    pageDesc:
      "Urgent = security, price, revolutionary tool. GitHub = trending repos.",
