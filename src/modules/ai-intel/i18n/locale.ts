...
export const UI = {
  fr: {
    ...
    tabTools: "Outils",
    tabNews: "Actus",
    sectionUrgentDesc: "Faille, prix, changement bloquant, projet qui décolle",
    ...
    emptyUrgentHint:
      "Uniquement ce qui demande une action : faille, prix, fin de support, ou un projet GitHub qui décolle.",
    tldr: "Résumé",
  ...
  en: {
    ...
    tabTools: "Tools",
    tabNews: "News",
    sectionUrgentDesc: "Security, pricing, breaking change, project taking off",
    ...
    emptyUrgentHint:
      "Action only: a security issue, a price or end-of-support change, or a GitHub project taking off.",
    tldr: "Summary",
